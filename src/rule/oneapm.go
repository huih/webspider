...
var woshipmDeleteContent = []string {
...
func formatwoshipmContent(removeDom []string, bodyContent *goquery.Selection) *goquery.Selection{
...
var woshipm = &Spider{
	Name:        "woshipm",
	Description: "woshipm博文采集 [http://www.woshipm.com/]",
		...
		Trunk: map[string]*Rule{
			...
			"详细页面": {
				...
				ParseFunc: func(ctx *Context) {
					...
					bodyContent = formatwoshipmContent(ctx.Spider.GetRemoveDom(), bodyContent)
					...
					//remove bad content
					for _, item := range woshipmDeleteContent {
